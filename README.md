					...
					<header id="header">
						<div class="content">
							<div class="inner">
								<h1>Portfolio</h1>
								<p>Christian Lee</p>
								<P>This is to showcase my work for the Projects I have worked on</P>
							</div>
						</div>
						<nav>
							<ul>
					...
					<div id="main">
						...
						<!-- Intro -->
							<article id="intro">
								...
								<p> I am currently in the Master in Data Science Program at UC Berkeley.
									As of now, the courses I am taking are Introduction to Data Science Programming, Research Design and Applications. 
									I'm pursuing a career in Data Engineering and Machine Learning.</p>

								<p> Prior to switching to the data world, I majored in Chemical Engineering at NC State. 
									I worked as a process/project engineer and ended my career as a project manager. 
									I have a lot of experience with good documentation practices, developing and executing engineering studies, and commissioning and qualification.
									</p>
								...
								<P>Click here to check out my <a href="#work"> work</a>.</P>
						...
						<!-- Work -->
							<article id="work">
								...
								<P>My berkeley course material can be found on this <a href="https://github.com/ejunlee/Berkeley_MIDS/tree/main"> repo</a>.</P>
						...
						<!-- About -->
							<article id="about">
								...
								<p>I am pursing a Master's in Data Science at UC Berkeley in pursuit of becoming a Data Scientist in the Tech world. 
									Currently, I'm a Senior Analyst at CREO working on a plethora of different projects. 
									My background before switching to a Data Analyst role was Pharmaceutical Manufacturing. 
									I started of as a process engineer and became a project manager who managed a COVID-19 project.</p>
								<ul class="icons">
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">&copy; Thank you</p>
					</footer>
